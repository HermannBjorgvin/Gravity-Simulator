...
define([
    ...
    var texturesList = document.getElementsByClassName('planet-texture');
    ...
    function getMomentum(object) {
        return getVelocity(object) * object.mass;
    }
    ...
    function objectConstructor(object) {
        ...
        //Add a random texture to the object
        this.texture = object.texture !== undefined ? object.texture : getRandomTexture();
    }
    ...
    function joinObjects(objectA, objectB) {
        if (
            ...
            var newObject = new objectConstructor({
                ...
                density: density,
                path: path,
                texture: objectA.mass > objectB.mass ? objectA.texture : objectB.texture //To keep the texture of the bigger body
            });
            addObject(newObject);
        }
    }
